...
DEFAULT_BIND_DIRS="$DEFAULT_BIND_DIRS" ./cuda-apptainer.sh exec env FOUNDATION_X_DATASET_LOCATIONS_YML="$DATASET_LOCATIONS_YML" python main_Consolidated.py --taskcomponent foundation_x5_pretraining \
