...
cyclictask=chexpertCLS_tbx11kCLS_tbx11kLOC_candidptxCLS_candidptxLOC_candidptxSEG
...
LOGFILE=${LOGFILE:-${SCRATCH:-/scratch/$USER}/FoundationX/v108/Model_Checkpoints/IntegratedModel_DINOpipeline/IntegratedModel_FoundationX3/run104_Ark6F6_ClsLocSeg_b24_AdamW_LockReleaseAll_RCons_1LocDec_TESTrun}
